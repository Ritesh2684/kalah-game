...
/**
 * This class checks if the last stone of the player lands in his own empty pit,
 * then move all the stones from his last pit and all stones from opposite pit
 * to his Kalah
 * 
...
@Component
@Order(4)
public class CheckLastStoneInEmptyPit implements KalahRule {

	KalahHelper kalahHelper = new KalahHelper();

	/**
	 * This method checks if the last stone of the player lands in his own empty
	 * pit, then move all the stones from his last pit and all stones from opposite
	 * pit to his Kalah
	 * 
