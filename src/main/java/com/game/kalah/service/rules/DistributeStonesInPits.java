...
/**
 * This class is responsible for distributing stones from selected pit to other
 * pits skipping the kalah of the opponent in anti-clockwise direction.
 * 
...
@Component
@Order(2)
public class DistributeStonesInPits implements KalahRule {

	/**
	 * This method distributes stones from selected pit to other pits skipping
	 * opponent's kalah in anti-clockwise direction Also, resets pit position when
	 * calculated pit postion is greater than total number of pits set last pit
	 * position for the rest of the rules of the game.
	 */
	@Override
	...
	/**
	 * This method resets the pit position , if next pit position calculated is
	 * greater than total number of pits in Kalah
	 * 
	 * @param nextPit calculated next pit position
	 * @return next pit position, reseting to 1, calculated position is greater than
