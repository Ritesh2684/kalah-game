...
public class KalahHelper {
	...
	public void identifyPlayer(Kalah kalah, int pitId) {
		...
		if(null == kalah.getCurrentPlayer()) {
			throw new KalahServiceException(Errors.INVALID_PIT_SELECTED.getErrorCode(), Errors.INVALID_PIT_SELECTED.getErrorMessage());
		}

	}
	
	/**
	 * This method checks if the position of the last distributed stone belongs to the current player.
	 * 
